...
export const QuestionIcon = () => <i className="ri-question-line"></i>;

export const KeyboardIcon = () => <i className="ri-keyboard-box-line"></i>;

export const UserIcon = () => <i className="ri-user-line"></i>;

export const CoinIcon = () => <i className="ri-copper-coin-line"></i>;

export const SettingIcon = () => <i className="ri-settings-2-line"></i>;

export const LogoutIcon = () => <i className="ri-logout-box-r-line"></i>;

export const UploadIcon = () => <i className="ri-upload-cloud-line" />;

export const SendIcon = () => <i className="ri-send-plane-line" />;

export const ChatIcon = () => <i className="ri-chat-3-line" />;

export const MoreIcon = () => <i className="ri-more-2-fill"></i>;

export const CloseIcon = () => <i className="ri-close-circle-fill"></i>;

export const LoaderIcon = () => <i className="ri-loader-4-fill"></i>;

export const SearchIcon = () => <i className="ri-search-line"></i>;
